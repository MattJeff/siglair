# Le plugin Claude Code — l'interface par-dessus les 154 outils

Le serveur MCP (`docs/MCP_SERVEUR.md`) rend 154 outils. Brancher une URL et une
clé donne 154 verbes bruts et aucun mode d'emploi : le modèle doit deviner
...
les 154 lignes du registre sont éditées par d'autres chantiers, et un outil
